...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Chi tiết các sản phẩm trong đơn bán hàng';
/*!40101 SET character_set_client = @saved_cs_client */;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_order_item_inserted` AFTER INSERT ON `order_items` FOR EACH ROW BEGIN
...
CREATE TABLE `orders` (
  ...
  `payment_method` enum('cash','card','e_wallet') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cash',
  `payment_status` enum('paid','pending','refunded') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `order_status` enum('draft','completed','cancelled','returned') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'completed',
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Đơn bán hàng tại quầy';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Chi tiết các sản phẩm trong đơn nhập hàng';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `purchase_order_items` VALUES (1,8,12,NULL,200,8000.00),(2,8,13,NULL,100,11000.00),(3,8,14,NULL,150,8000.00),(4,8,15,NULL,100,8000.00),(5,9,19,NULL,300,3500.00),(6,9,20,NULL,200,3500.00),(7,10,23,NULL,100,12000.00),(8,10,24,NULL,80,35000.00),(9,10,26,NULL,150,8000.00),(10,11,12,NULL,20,10000.00),(11,12,2,NULL,10000,10000.00);
...
CREATE TABLE `purchase_orders` (
  ...
  `staff_id` int NOT NULL,
  `total_amount` decimal(14,2) NOT NULL DEFAULT '0.00',
  `status` enum('pending','received','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Đơn nhập hàng từ nhà cung cấp';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `purchase_orders` VALUES (1,1,1,5000000.00,'received','Đặt thùng Coca và Pepsi','2026-04-01 09:00:00','2026-04-02 14:30:00'),(2,2,2,2500000.00,'received','Nhập mì Hảo Hảo các vị','2026-04-05 10:15:00','2026-04-06 09:00:00'),(3,3,1,1800000.00,'pending','Đặt cà phê G7 hộp','2026-05-10 11:30:00',NULL),(4,1,2,3200000.00,'cancelled','Hủy do nhà cung cấp hết hàng','2026-05-08 14:00:00',NULL),(5,1,6,0.00,'pending','Đặt nước ngọt tháng 5','2026-05-01 09:00:00',NULL),(6,2,6,0.00,'pending','Đặt mì gói các loại','2026-05-03 10:30:00',NULL),(7,11,6,0.00,'cancelled','Đặt bánh kẹo cho lễ hè | Đã hủy bởi Nguyễn Thanh Quang','2026-05-05 14:00:00',NULL),(8,1,6,4700000.00,'received','Đặt nước ngọt tháng 5','2026-05-01 09:00:00','2026-05-12 08:31:15'),(9,2,6,1750000.00,'received','Đặt mì gói các loại','2026-05-03 10:30:00','2026-05-12 08:38:08'),(10,11,6,5200000.00,'received','Đặt bánh kẹo cho lễ hè','2026-05-05 14:00:00','2026-05-12 08:38:41'),(11,2,1,200000.00,'received','Nhập hàng từ nhà cung cấp','2026-06-20 16:05:11','2026-06-20 16:05:24'),(12,2,1,100000000.00,'received','Nhập hàng từ nhà cung cấp','2026-06-20 17:11:55','2026-06-20 17:12:03');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_purchase_received` BEFORE UPDATE ON `purchase_orders` FOR EACH ROW BEGIN
...
-- Dump completed on 2026-06-20 17:31:12
